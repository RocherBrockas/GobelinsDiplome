...
public class PlatformerMotor2D : MonoBehaviour
{
    ...
    public void AbilityChange(Perception perception)
    {
        if (perception != null)
        {
            ...
            timeToAirSpeed = perception.airAcceleration;
            airStopDistance = perception.airStopDistance;
            fallSpeed = perception.fallSpeed;
            gravityMultiplier = perception.gravityMultiplier;
